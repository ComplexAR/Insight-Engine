...
1. Download **`dist/insight-engine-0.1.20.plugin`** from this repo (or from the latest [Release](../../releases)).
2. In Cowork, open **Customize → Skills → Upload from file** and choose the `.plugin`.

## Version

**0.1.20.** For how releases are cut, see [PUBLISHING.md](PUBLISHING.md).
