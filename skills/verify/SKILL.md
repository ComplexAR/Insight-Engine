...
- **Irreducibly open** (a value, a framing, or a forecast about the future): flag it for human judgement; it is not verifiable and must not be graded at all: it is routed, not marked `[V]` or `[N]`.
