...
tb(s,0.92,6.5,11.2,0.4,"An open plugin for Claude Code & Cowork   ·   v0.1.18",16,MUTE)
...
tb(s,7.15,2.66,5.2,2.7,[
    [("A · different-LAB model (GPT-5.6 Sol, Gemini, Grok, or any OpenAI-compatible endpoint) — strongest; runs ALONGSIDE the Anthropic model, never alone. Invoked by an API call — the engine guides set-up. ",13,False,INK),("OpenAI live-verified; Gemini/Grok built to spec, not yet live-smoked; opt-in, off by default; data leaves the boundary, so privileged/confidential blocked by default — overridable by a deliberate, logged act.",13,False,DAMBER,F,True)],
